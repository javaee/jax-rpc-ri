/*
 * $Id: Resolver.java,v 1.1 2006-04-12 20:34:24 kohlert Exp $
 */
...
public class Resolver implements EntityResolver {
    ...
    static public InputSource createInputSource(URL uri, boolean checkType)
        ...
        if (checkType) {
            ...
            retval =
                new InputSource(XmlReader.createReader(conn.getInputStream()));
        }
    ...
    static public InputSource createInputSource(File file) throws IOException {
        ...
        retval =
            new InputSource(XmlReader.createReader(new FileInputStream(file)));
